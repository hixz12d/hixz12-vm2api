...
export const KEYWORD_VENDOR_RULES: ReadonlyArray<readonly [RegExp, string]> = [
  ...
  [/deepseek/, 'deepseek'],
  [
    /doubao|seedance|seedream|seed-oss|\bseed-\d|ui-tars|bytedance|volcengine/,
    'bytedance',
  ],
  [/nemotron|\bnvidia\b/, 'nvidia'],
  [/\bphi-?\d|wizardlm|\borca-2|\bmai-(ds|voice|\d)/, 'microsoft'],
  [
    /\byi-\d|\byi-(lightning|vision|large|medium|coder|spark)|\b01-?ai|yi1\.5/,
    '01-ai',
  ],
  ...
  [
    /black-forest|\bflux-?\d|\bflux-(pro|dev|schnell|kontext|krea|1)|\bflux\b/,
    'bfl',
  ],
  [/\bkling/, 'kling'],
  [/recraft/, 'recraft'],
  ...
  [
    /chatglm|autoglm|charglm|codegeex|cogview|cogvideo|\bglm-?\d|\bglm-|\bglm\b|zhipu/,
    'zhipuai',
  ],
...
const LOBEHUB_BRAND_RULES: ReadonlyArray<readonly [string, string]> =
  Object.entries(LOBEHUB_BRAND_VENDORS).sort(
