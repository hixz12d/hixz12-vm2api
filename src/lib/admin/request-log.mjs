  ...
  finish(ctx, extra = {}) {
    ...
    if (ctx.mode === 'debug') {
      const debugRec = {
        ...
        upstream_error: extra.upstream_error ? clampBody(extra.upstream_error, 2048) : null,
        session_queue_ms: extra.session_queue_ms ?? null,
        stream_progress: extra.stream_progress ? clampBody(extra.stream_progress, 2048) : null,
